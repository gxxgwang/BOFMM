...
class Visualizer:
    ...
    def visualize(self, driving, source, out):
        ...
        prediction = out['prediction_sd'].data.cpu().numpy()
        ...
        prediction = out['prediction_sds'].data.cpu().numpy()
        prediction = np.transpose(prediction, [0, 2, 3, 1])
        # if 'kp_norm' in out:
        #     kp_norm = out['kp_norm']['fg_kp'].data.cpu().numpy()
        #     images.append((prediction, kp_norm))
        ...
        prediction = out['prediction_ds'].data.cpu().numpy()
        prediction = np.transpose(prediction, [0, 2, 3, 1])
        # if 'kp_norm' in out:
        #     kp_norm = out['kp_norm']['fg_kp'].data.cpu().numpy()
        #     images.append((prediction, kp_norm))
        ...
        prediction = out['prediction_dsd'].data.cpu().numpy()
        prediction = np.transpose(prediction, [0, 2, 3, 1])
        # if 'kp_norm' in out:
        #     kp_norm = out['kp_norm']['fg_kp'].data.cpu().numpy()
        #     images.append((prediction, kp_norm))
        ...
        # Deformed S->D->S image
        # if 'deformed_StoDtoS' in out:
        #     deformed = out['deformed_StoDtoS'].data.cpu().numpy()
