...
def read_video(name, frame_shape):
    ...
    if os.path.isdir(name):
        ...
        video_array = np.array([resize_fn(io.imread(os.path.join(name, frames[idx]))) for idx in range(num_frames)])
...
class FramesDataset(Dataset):
    ...
    def __init__(self, root_dir, frame_shape=(256, 256, 3), id_sampling=False, is_train=True,
        ...
        train_videos = sorted(train_videos)[0:700]################
...
#     yaml_path = 'config/mgif-256.yaml'
